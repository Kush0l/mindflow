...
async function analyzeJournal(journalText) {
  ...
  const prompt = `Analyze this student's journal entry. Extract emotional features and cognitive distortions, and provide empathetic reframing and a recommended mindfulness breathing exercise.
